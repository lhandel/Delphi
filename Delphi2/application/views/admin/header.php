...
<html>
  ...
  <div class="menu">
    ...
    <ul>
      ...
      <li><a href="<?php echo site_url('index.php/admin/login?url='); ?><?php echo urlencode(site_url('index.php/admin/serviceManagement')); ?>" id="item4"><i class="fa fa-wrench" aria-hidden="true"></i> Service Management</a></li>
