...
<html>
  ...
  <div class="menu">
    ...
    <ul>
      ...
      <li><a href="<?php echo site_url('index.php/admin/login?url='); ?><?php echo urlencode(site_url('index.php/admin/AdminMangement')); ?>" id="item3"><i class="fa fa-users" aria-hidden="true"></i> Admin Management</a></li>
