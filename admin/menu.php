...
<div class="menu">
  ...
  <ul>
    ...
    <li><a href="am.php" id="item3"><i class="fa fa-users" aria-hidden="true"></i> Admin Mangement</a></li>
    <li><a href="login.php?url=settings.php" id="item4"><i class="fa fa-wrench" aria-hidden="true"></i> Settings</a></li>
  </ul>
